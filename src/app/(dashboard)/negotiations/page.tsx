...
export default function NegotiationsPage() {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle className="font-headline text-2xl text-primary">Assistente Inteligente de Vendas</CardTitle>
          <CardDescription>
            Descreva o que o cliente procura e a IA encontrará os melhores pacotes, com justificativas e um rascunho de proposta.
          </CardDescription>
        </CardHeader>
        <Form {...form}>
      ...
      {recommendations && (
        <Card>
            <CardHeader>
                <CardTitle className="font-headline text-primary">Recomendações e Proposta</CardTitle>
