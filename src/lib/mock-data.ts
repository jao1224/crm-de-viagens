...
export const mockReservations: Reservation[] = [
    { id: '1', customerName: 'Carla Dias', packageId: '1', packageName: 'Resort Tropical em Cancún', bookingDate: '2024-08-01', travelDate: '2024-09-15', status: 'Confirmada', totalPrice: 9000, travelers: 2, agentId: '2', agentAvatarUrl: 'https://placehold.co/100x100' },
    { id: '2', customerName: 'Eduarda Souza', packageId: '2', packageName: 'Aventura nos Alpes Suíços', bookingDate: '2024-08-05', travelDate: '2024-09-05', status: 'Pendente', totalPrice: 14400, travelers: 2, agentId: '7', agentAvatarUrl: 'https://placehold.co/100x100' },
    { id: '3', customerName: 'Fábio Martins', packageId: '6', packageName: 'Férias em Roma e Vaticano', bookingDate: '2024-08-10', travelDate: '2024-10-20', status: 'Confirmada', totalPrice: 11800, travelers: 2, agentId: '2', agentAvatarUrl: 'https://placehold.co/100x100' },
    { id: '4', customerName: 'Carla Dias', packageId: '4', packageName: 'Viagem de Negócios a Nova York', bookingDate: '2024-08-15', travelDate: '2024-08-30', status: 'Cancelada', totalPrice: 5300, travelers: 1, agentId: '10', agentAvatarUrl: 'https://placehold.co/100x100' },
    { id: '5', customerName: 'Eduarda Souza', packageId: '5', packageName: 'Safari na Tanzânia', bookingDate: '2024-08-20', travelDate: '2024-11-10', status: 'Confirmada', totalPrice: 25000, travelers: 2, agentId: '7', agentAvatarUrl: 'https://placehold.co/100x100' },
    { id: '6', customerName: 'Fábio Martins', packageId: '7', packageName: 'Diversão em Família em Orlando', bookingDate: '2024-11-25', travelDate: '2024-12-15', status: 'Confirmada', totalPrice: 15000, travelers: 4, agentId: '2', agentAvatarUrl: 'https://placehold.co/100x100' },
    { id: '7', customerName: 'Carla Dias', packageId: '8', packageName: 'Combo Cultural: Rio e Salvador', bookingDate: '2024-11-10', travelDate: '2025-01-20', status: 'Confirmada', totalPrice: 12400, travelers: 2, agentId: '10', agentAvatarUrl: 'https://placehold.co/100x100' },
    { id: '8', customerName: 'Carla Dias', packageId: '2', packageName: 'Aventura nos Alpes Suíços', bookingDate: '2025-01-20', travelDate: '2025-03-10', status: 'Confirmada', totalPrice: 7200, travelers: 1, agentId: '7', agentAvatarUrl: 'https://placehold.co/100x100' },
    { id: '9', customerName: 'Fábio Martins', packageId: '1', packageName: 'Resort Tropical em Cancún', bookingDate: '2025-02-15', travelDate: '2025-04-05', status: 'Pendente', totalPrice: 9000, travelers: 2, agentId: '2', agentAvatarUrl: 'https://placehold.co/100x100' },
];
