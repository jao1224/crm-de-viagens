  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_start: "day-range-start bg-primary text-primary-foreground hover:bg-primary/90 rounded-l-md",
        day_range_end: "day-range-end bg-chart-2 text-primary-foreground hover:bg-chart-2/90 rounded-r-md",
        ...classNames,
      }}
      components={{
